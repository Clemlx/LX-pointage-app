...
import com.lxcommissioning.app.data.models.Note;
...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `Note` (`id`,`siteId`,`content`,`timestamp`,`author`,`syncStatus`) VALUES (?,?,?,?,?,?)";
      }
  ...
  @Override
  public Flow<List<Note>> getNotesForSite(final String siteId) {
    final String _sql = "SELECT * FROM Note WHERE siteId = ? ORDER BY timestamp DESC";
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpId,_tmpSiteId,_tmpContent,_tmpTimestamp,_tmpAuthor,_tmpSyncStatus);
            _result.add(_item);
          }
          return _result;
        } finally {
